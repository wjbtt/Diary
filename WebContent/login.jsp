...
<div class="container">
      <form name="myForm" class="form-signin" action="login" method="post" onsubmit="return checkForm()">
        <h2 class="form-signin-heading">饭宝宝日记本</h2>
        ...
        <button class="btn btn-large btn-primary" type="button" >重置</button>
         &nbsp;&nbsp;&nbsp;&nbsp;
      <button class="btn btn-large btn-primary" type="button" onclick="javascript:window.location='reg.jsp'">注册</button>

<p align="center" style="padding-top: 15px;">版权所有  2017  饭宝宝</p>
      </form>
</div>
</body>
</html>